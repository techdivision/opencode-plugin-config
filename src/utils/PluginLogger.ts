 ...
 *
 * @see {@link PluginLoggerInterface} in `interfaces/PluginLoggerInterface.ts` - Interface definition
 ...
 * ```
 */
export function createPluginLogger(client: LogClient, service: string): PluginLoggerInterface {
  /**
